...
> 2. Determine the number of `CutChurro` calls made by `CutChurro[n]` as a function of $n$, for $n \geq 0$. You don't need to give a formal proof (unless you want to), but if you don't, you still need to justify your answer in a way that is convincing.
...
> 3. Compute the elapsed system time for `CutChurro(n)` for values of $n$ from 10 to 20. What do you notice about this sequence of numbers?
