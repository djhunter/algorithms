...
> 3. Suppose that $n = \left(\frac{3}{2}\right)^p+1$. Let $D(p) = C\left(\left(\frac{3}{2}\right)^p+1\right)$. Give a recurrence relation for $D(p)$ (in terms of $p$) and find a closed-form solution (in terms of $p$). *Hint:* This part is actually easier if you include the ceiling in your recurrence relation.



> 4. Substitute $n = \left(\frac{3}{2}\right)^p+1$, or equivalently, $p = \log_{1.5} (n-1)$, into your closed-form solution to obtain a closed-form solution for $C(n)$ (in terms of $n$.)


For 3 and 4, do the algebra on scratch paper, and don't bother typesetting all of the steps.
