...
**Note:** The second while loop won't remove intervals that have later end times than some stabbed interval. But these will get removed eventually, at the very latest, at the last stab. This peculiarity does not affect the greedy choices, or the final value of `counter`.
