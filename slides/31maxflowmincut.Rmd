...
Draw the residual graph for the graph on the Jamboard.
...
- Since the augmenting path is itself a flow, the conservation property is conserved at each vertex.
    - Details in book.
...
- Maximum flow algorithms is still an active area of research.
